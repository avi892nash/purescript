module  Language.PureScript.CodeGen.JS.Optimizer where
...
optimizeCoreFnForJS :: Module Ann -> Module Ann
optimizeCoreFnForJS m = fmap (\md -> m {moduleDecls = md}) optimizeModuleDecls $ moduleDecls m
...
-- |
-- CloseRecord optimization is only beneficial for JSCodeGen
--
